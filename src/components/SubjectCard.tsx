  ...
  return (
    <div className="rounded-xl p-6 card">
      <div className="flex items-center mb-4">
        <span className="card-icon mr-3">{subject.icon}</span>
      ...
      <Accordion type="single" collapsible className="space-y-2">
        {subject.papers.map((paper) => {
          // Get the quiz data to access individual quizzes
          const mainQuiz = getQuizById(paper.id);
          // Get individual quizzes (Quiz 1, 2, 3) based on the paper ID
            ...
            <AccordionItem key={paper.id} value={paper.id}>
              ...
              <AccordionContent>
                <ul className="space-y-2 pl-4 mt-2">
                  ...
                  {/* Links to individual topic quizzes */}
